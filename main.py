...
for i, y in zip(all_instances, postion):
    ...
    if i.__class__.__name__ == "ZeroShotAgent":
        base_class["data"]["nodes"].append(
            get_template("agents", "ZeroShotAgent", y, lc_kwargs)
        )
    if i.__class__.__name__ == "AgentExecutor":
        all_agents = dir(langchain.agents)
        for j in function_list:
            if j.__name__ in all_agents:
                ...
                base_class["data"]["nodes"].append(
                    get_template("agents", func_name, y, lc_kwargs)
                )
    ...
    if i.__module__.startswith("langchain.chains"):
        base_class["data"]["nodes"].append(
            get_template("chains", i.__class__.__name__, y, lc_kwargs)
        )
    ...
    # Loaders
        ...
        base_class["data"]["nodes"].append(
            get_template("documentloaders", i.__class__.__name__, y, lc_kwargs)
        )
    ...
    # Embeddings
        ...
        base_class["data"]["nodes"].append(
            get_template("embeddings", i.__class__.__name__, y, lc_kwargs)
        )
    #     print(i.__class__)
    ...
    # LLms
        ...
        base_class["data"]["nodes"].append(
            get_template("llms", i.__class__.__name__, y, lc_kwargs)
        )
    ...
    # Memories
        ...
        base_class["data"]["nodes"].append(
            get_template("memories", i.__class__.__name__, y, lc_kwargs)
        )
    ...
    # Prompts
        ...
        base_class["data"]["nodes"].append(
            get_template("prompts", i.__class__.__name__, y, lc_kwargs)
        )
    ...
    # TextSplitters
        ...
        base_class["data"]["nodes"].append(
            get_template("textsplitters", i.__class__.__name__, y, lc_kwargs)
        )
    ...
    # ToolKits
        ...
        base_class["data"]["nodes"].append(
            get_template("toolkits", i.__class__.__name__, y, lc_kwargs)
        )
    ...
    # Tools
        ...
        base_class["data"]["nodes"].append(
            get_template("tools", i.__class__.__name__, y, lc_kwargs)
        )
    ...
    # Utilities
        ...
        base_class["data"]["nodes"].append(
            get_template("utilities", i.__class__.__name__, y, lc_kwargs)
        )
    ...
    # Vectors Stores
        ...
        base_class["data"]["nodes"].append(
            get_template("vectorstores", i.__class__.__name__, y, lc_kwargs)
        )
    ...
    # Wrappers
        ...
        base_class["data"]["nodes"].append(
            get_template("wrappers", i.__class__.__name__, y, lc_kwargs)
        )
